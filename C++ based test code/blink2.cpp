...
main(int argc, char *argv[])
{
	...
	if ( -1 == GPIODirection(27, IN))		//left
		 ...
		 * Write GPIO value
		 */
		if (-1 == GPIOWrite(13, 0))	//green on
			return(3);
		if (-1 == GPIOWrite(12, 0))	//yellow on
			return(3);
		if (-1 == GPIOWrite(22, 0))	//blue on
			return(3);
	do {
		 ...
		 * Read GPIO value
		 */
		 if(GPIORead(17) && GPIORead(27))
		 {
		GPIOWrite(12, 0);
		GPIOWrite(22, 0);
			GPIOWrite(13, 0);
		printf("No pins are being triggered");
		}
		 if(GPIORead(17) && !GPIORead(27))
		 {
		GPIOWrite(12, 1);
		...
		GPIOWrite(12, 0);
		GPIOWrite(13, 0);
		printf("I'm reading both inputs\n");
		}
	...
	while (repeat--);
		...
		if (-1 == GPIOWrite(13, 0))		//green off
			return(3);
		if (-1 == GPIOWrite(12, 0))		//yellow off
			return(3);
		if (-1 == GPIOWrite(22, 0))		//blue off
			return(3);
